...
RSpec.describe Invoice, type: :model do
  ...
  describe 'class methods' do
    before :each do
      ...
      @discountm5 = BulkDiscount.create(merchant_id: @merch[5].id, threshold: 15, percent_discount: 25)
      @discountm6 = BulkDiscount.create(merchant_id: @merch[6].id, threshold: 10, percent_discount: 20)
      @discountm7 = BulkDiscount.create(merchant_id: @merch[6].id, threshold: 25, percent_discount: 30)
      ...
      @inv_item13 = create(:invoice_item, invoice: @invoice7, item: @item3, unit_price: 3000, quantity: 3)
    ...
    describe '#all_merch_invoices' do
      it 'returns all invoices for a merchant' do
        expect(Invoice.all_merch_invoices(@merch[0])).to eq([@invoice, @invoice1, @invoice7])
      end
    end
  end
end

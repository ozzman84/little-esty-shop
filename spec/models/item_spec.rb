...
RSpec.describe Item do
  ...
  describe 'best day' do
    before :each do
      ...
      @ii1 = create(:invoice_item, invoice: @inv0, item: @items[1], quantity: 2, unit_price: 100)
      @ii2 = create(:invoice_item, invoice: @inv0, item: @items[2], quantity: 10, unit_price: 200)
      @ii3 = create(:invoice_item, invoice: @inv1, item: @items[3], quantity: 4, unit_price: 40)
      @ii4 = create(:invoice_item, invoice: @inv1, item: @items[4], quantity: 12, unit_price: 30)
      @ii5 = create(:invoice_item, invoice: @inv1, item: @items[5], quantity: 20, unit_price: 90)
      @ii6 = create(:invoice_item, invoice: @inv2, item: @items[6], quantity: 3, unit_price: 50)
      @ii7 = create(:invoice_item, invoice: @inv2, item: @items[1], quantity: 6, unit_price: 80)
      @ii8 = create(:invoice_item, invoice: @inv3, item: @items[2], quantity: 10, unit_price: 75)
      @ii9 = create(:invoice_item, invoice: @inv3, item: @items[2], quantity: 7, unit_price: 60)
      @ii10 = create(:invoice_item, invoice: @inv4, item: @items[0], quantity: 1000, unit_price: 800)
